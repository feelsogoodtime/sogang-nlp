...
def main(
    ...
    if train_path is None:
        train_path = os.path.join(os.path.dirname(metadata), 'train.list').replace('\\', '/')
    if val_path is None:
        val_path = os.path.join(os.path.dirname(metadata), 'val.list').replace('\\', '/')
    out_config_path = os.path.join(os.path.dirname(metadata), 'config.json').replace('\\', '/')
