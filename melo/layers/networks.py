...
class AcousticDecoder(nn.Module):
    ...
    def get_pitch_embedding(self, pred, target, mask, control=1.2):
    ...
    def get_energy_embedding(self, pred, target, mask, control=1.1):
        if target is not None:
        ...
        self.convolutions.append(
            nn.Sequential(
                nn.Conv1d(n_mel_channels, postnet_embedding_dim,
                         kernel_size=postnet_kernel_size, padding=(postnet_kernel_size-1)//2),
